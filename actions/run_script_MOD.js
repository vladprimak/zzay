module.exports = {
    ...
    subtitle(data) { return `${data.code}`; },

    html() {
        return `
        <div style='right: 53px;' class='helpDiv'>
            <button class='helpButton icon' onclick='changeState("helpTextDiv");'>
                <i class='setting icon'></i>
            </button>
        </div>
        <div style='right: 53px;' id='helpTextDiv'>
            <ul style='list-style: none; margin-left: -25px;'>
            <li> The mod was created for the <a href='#' onclick='DBM.openLink("https://github.com/MineEjo/DBM-Horizon-Theme")'> Horizon theme </a>.
            </li>
        ...
        <div id='maximixeDiv'>
            <button id='fullScreen' class='icon' onclick='changeScreen()'>
        ...
        <style>.action-input { margin: 0 !important; padding: 0 !important; }</style>`;
    },
    ...
    init() {
        ...
        <style>
          #editor { position: absolute; color: #bbbbbb; background: #1c1e26; top: 0; left: 0; right: 0; bottom: 0;
          font-size: 14.0;} .ace-monokai { color: #bbbbbb; background: #1c1e26;}
          .ace-monokai .ace_gutter { background: #1c1e26; color: #4A4F5B; border-right: 1px solid #3B3F48; }
          .ace-monokai .ace_marker-layer .ace_selection { background: #22252f; }
          .ace-monokai.ace_multiselect .ace_selection.ace_start { box-shadow: 0 0 0 0 #black; }
          .ace-monokai .ace_marker-layer .ace_step { background: none; }
          .ace-monokai .ace_marker-layer .ace_bracket { margin: -1px 0 0 -1px; border: 1px solid #3B3F48; }
          .ace-monokai .ace_marker-layer .ace_active-line { background: #22252f; }
          .ace-monokai .ace_gutter-active-line { background-color: #22252f; color: #bbbbbb; }
          .ace-monokai .ace_marker-layer .ace_selected-word { border: 1px solid #3B3F48; }
          .ace-monokai .ace_invisible { color: #22252f; }
          .ace-monokai .ace_cursor { color: #d34c6e; }
          .ace-monokai .ace_entity.ace_name.ace_tag,
          .ace-monokai .ace_keyword,
          .ace-monokai .ace_meta.ace_tag,
          .ace-monokai .ace_storage { color: #d55170; }
          .ace-monokai .ace_punctuation,
          .ace-monokai .ace_punctuation.ace_tag { color: #fff; }
          .ace-monokai .ace_constant.ace_character,
          .ace-monokai .ace_constant.ace_language,
          .ace-monokai .ace_constant.ace_numeric,
          .ace-monokai .ace_constant.ace_other { color: #24a2ae; }
          .ace-monokai .ace_invalid { color: #F8F8F0; background-color: #d55170; }
          .ace-monokai .ace_invalid.ace_deprecated { color: #F8F8F0; background-color: #24a2ae; }
          .ace-monokai .ace_support.ace_constant,
          .ace-monokai .ace_support.ace_function { color: #24a2a1; }
          .ace-monokai .ace_storage.ace_type,
          .ace-monokai .ace_support.ace_class,
          .ace-monokai .ace_support.ace_type { font-style: italic; color: #d55170; }
          .ace-monokai .ace_entity.ace_name.ace_function,
          .ace-monokai .ace_entity.ace_other,
          .ace-monokai .ace_entity.ace_other.ace_attribute-name,
          .ace-monokai .ace_variable { color: #896eca; } 
          .ace-monokai .ace_variable.ace_parameter { font-style: italic; color: #FD971F }
          ::-webkit-scrollbar { width: 8px; } .ace-monokai .ace_string { color: #e49b60; }
          .ace-monokai .ace_comment { color: #4c4d4f; } ::-webkit-scrollbar-track { background: #1c1e26; }
          ::-webkit-scrollbar-thumb { background-color: #22252f; }
          ::-webkit-scrollbar-thumb:hover { background-color: #44475d; }
          </style>`;
