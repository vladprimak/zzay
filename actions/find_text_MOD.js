module.exports = {
    ...
    subtitle(data) { return `Find "${data.toFind}"`; },
    ...
    init() {
        ...
        glob.changeOption = function (value) {
            const text = ['Insert text here...', 'Insert the first, second word here... [Example: hello,bye]',
                          'Insert here the first and second position... [Example: 0,5]',
                          'Insert a regex expression here... [Example: /[A-Z]/g]'];
    ...
    action(cache) {
        ...
        switch (option) {
            case 0:
                ...
                if (additionally === 2) result =
                    [text.slice(text.indexOf(toFind), toFind.length + text.indexOf(toFind)), text.indexOf(toFind),
                     toFind.length + text.indexOf(toFind)]
                break;
            case 1:
                ...
                if (additionally === 2) result =
                    [text.slice(text.indexOf(arrayWords[0]), text.indexOf(arrayWords[1])), text.indexOf(arrayWords[0]),
                     text.indexOf(arrayWords[1])];
                break;
            case 2:
                ...
                if (additionally === 2) result =
                    [text.slice(arrayNumbers[0], arrayNumbers[1]), arrayNumbers[0], arrayNumbers[1]];
                break;
            case 3:
